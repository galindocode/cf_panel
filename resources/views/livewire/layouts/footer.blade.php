<footer class="p-4 bg-white rounded-lg shadow md:px-6 md:py-8 bg-primary  bottom-0 w-full">
    <div class="sm:flex sm:items-center sm:justify-between">
        <a href="{{url('/')}}" class="flex items-center mb-4 sm:mb-0">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">EmpresarioDigital</span>
        </a>
    ...
    <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com"
            class="hover:underline">EmpresarioDigital</a>. Todos los Derechos Reservados.
    </span>
</footer>